...
from code.my_movies_cards import add_user_to_db_users_last_removed_movie_from_my_movies_list
...
async def my_movies_list_in_cards_view(message: types.Message):
    ...
    if count_users_movies > 0:
        ...
        add_user_to_db_users_last_removed_movie_from_my_movies_list(user_id, kinopoisk_id)
